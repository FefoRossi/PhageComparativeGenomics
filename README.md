...
#We already did this step for the generation of protein based clsuter but we will repeat it here
...
array = clsuter_matrix.to_numpy()

#2 the labels

labels = clsuter_matrix.index.tolist()
